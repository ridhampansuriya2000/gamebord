...
export default function MindiTable({ gameState, mySeat, players = [],  playerNames = {},
  ...
  return (
    <div className="w-full h-full max-h-full sm:max-h-none sm:h-auto max-w-7xl sm:aspect-video bg-green-900/60 rounded-2xl sm:rounded-[3rem] border-4 sm:border-8 border-amber-900/80 shadow-xl sm:shadow-2xl relative overflow-hidden flex items-center justify-center">
