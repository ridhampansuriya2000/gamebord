...
export const getValidCards = (hand, currentTrick) => {
...
// Check if a card play is valid (useful for backend validation)
export const isValidCardPlay = (cardId, hand, currentTrick) => {
